...
function presentarInformacion (radio, volumenEsfera) {
    //1 presentamos ladivision de resultado
    const divResultado = document.querySelector("#divResultado");
    //2 creamos la cadena de caracteres que se mostrara en la division
    const solucion = "<p>Una esfera de radio <code>" + radio + "</code> tiene un volumen de <code>" 
    + volumenEsfera + "</code> unidades </p>";
    //3 mostramos las cadenas de caracteres 
